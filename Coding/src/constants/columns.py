...
VEHICLE_MAKE_COL = "vehicle_make"
VEHICLE_MODEL_COL = "vehicle_model"
VEHICLE_START_YEAR_COL = "vehicle_start_year"
...
# Year binning
YEAR_BIN_LOWER: int = 2020
YEAR_BIN_UPPER: int = 2026
YEAR_BIN_UPPER_REPLACEMENT: int = 2025