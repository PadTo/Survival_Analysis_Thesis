...
from .constants.processor import (
    ...
    FIRST_PERIOD_IN_DAYS, SECOND_PERIOD_IN_DAYS, N_NEIGHBOURS,
    UNKNOWN_VALUE, NONE_ACTIVITY_VALUE,
    COL_TEMPLATE_FORMAT, PROP_COL_TEMPLATE, TOTAL_ACTIONS_COL_TEMPLATE,
    OVERALL_PROP_COL_TEMPLATE, CUMULATIVE_COUNT_COL_TEMPLATE,
    DRIFT_COL_TEMPLATE, INTENSITY_DRIFT_COL_TEMPLATE,
    SESSIONS_TOKEN, ACTIONS_TOKEN, STILL_IN_PRODUCTION_TOKEN,
    TOTAL_CARS_TOKEN, TOTAL_APP_TOKEN,
    FIRST_YEAR_COL, START_DATE_COL, END_DATE_COL,
    LAST_ACTIVITY_DATE_COL, RECENCY_COL, INTERVAL_END_COL,
    PROP_IN_PROD_COL, CUMULATIVE_COUNT_TOTAL_COL, MEAN_AGE_INTERMEDIATE_COL,
    VEHICLE_AGE_COLUMN_NAME, VEHICLE_MEAN_AGE_COLUMN_NAME,
    VEHICLE_MEAN_OVERALL_AGE_COLUMN_NAME, FIRST_DISTINCT_COLUMN_NAME,
...
class DataProcessor():
    ...
    def apply_feature_engineering(self,
                                   ...
                                   sum_to_limit_in_days: int = SUM_TO_LIMIT_IN_DAYS,
                                   first_period: int = FIRST_PERIOD_IN_DAYS,
                                   second_period: int = SECOND_PERIOD_IN_DAYS) -> pl.DataFrame | None:
        """
